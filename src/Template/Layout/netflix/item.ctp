...
<head>
    ...
    <?= $this->Html->css('netflix/footer.css') ?>
    <?= $this->Html->css('netflix/item.css') ?>
</head>
  ...
  <?= $this->Html->script('auto_loading/netflix/loading_item_review.js') ?>
  <?= $this->Html->script('netflix/item.js') ?>
</body>
</html>
</head>
