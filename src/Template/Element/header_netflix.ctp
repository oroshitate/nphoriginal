<nav class="navbar navbar-dark header">
  <div class="header-div">
      ...
      <?= $this->Form->end() ?>
      <?= $this->Html->link('NPHoriginal','/netflix/about', ['id' => 'header-title', 'class' => 'navbar-brand mb-0']) ?>
  ...
  <div class="header-menu">
    <?= $this->Html->link('Original','/netflix/original', ['class' => 'header-menu-original']) ?>
    <?= $this->Html->link('Review','/netflix/review', ['class' => 'header-menu-review']) ?>
    <?= $this->Html->link('Recommend','/netflix/recommend', ['class' => 'header-menu-recommend']) ?>
