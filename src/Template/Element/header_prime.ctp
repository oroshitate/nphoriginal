<nav class="navbar navbar-dark header">
  <div class="header-div">
      ...
      <?= $this->Form->end() ?>
      <?= $this->Html->link('NPHoriginal','/prime/about', ['id' => 'header-title', 'class' => 'navbar-brand mb-0']) ?>
  ...
  <div class="header-menu">
    <?= $this->Html->link('Original','/prime/original', ['class' => 'header-menu-original']) ?>
    <?= $this->Html->link('Review','/prime/review', ['class' => 'header-menu-review']) ?>
