...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item content-tab-li">
      <a href="#tab3" class="nav-link tab-li-nav text-center" data-toggle="tab">
...
<div class="tab-content content-tab">
  <div id="tab1" class="tab-pane content-tab1 active">
      ...
      <div class="content-tab1-col1">
        <div class="card content-tab1-card">
          <?= $this->Html->image('netflix_new_image.png', ['alt' => 'netflix_new_image', 'class'=>'card-img-top']) ?>
          <div class="card-body">
      ...
      <div class="content-tab1-col2">
        <div class="card content-tab2-card">
          <?= $this->Html->image('netflix_list_image.png', ['alt' => 'netflix_list_image', 'class'=>'card-img-top']) ?>
           <div class="card-body">
  ...
  <div id="tab3" class="tab-pane content-tab3">
    <div class="content-tab3-col1">
      <div class="card content-tab3-card">
        <?= $this->Html->image('recommend_image.png', ['alt' => 'recommend-image', 'class'=>'card-img-top']) ?>
        <div class="card-body">
          <p class="card-text">各作品と似た作品を表示します</p>
          <p class="card-text">あなたが面白いと思った作品を選べばそれと似た作品が表示されます</p>
          <?= $this->Form->create(null, ['url' => ['controller' => '/Recommend', 'action' => 'index']]) ?>
            <button type="submit" class="btn btn-secondary"><?php echo "おすすめ"; ?></button>
          <?= $this->Form->end() ?>
        </div>
      </div>
    </div>
