            ...
            setTimeout(function() {
                    ...
                    .done(function(response){
                        ...
                        for(var i=0; i<review_list.length; i++){
                            ...
                            $("<li class='list-group-item target-review review-list-item'><p><span class='review-title' data-id='"+review_list[i]['id']+"'  data-itemid='"+review_list[i]['item_id']+"'>"+review_list[i]["netflix_item"]["title"]+"</span></p><div class='review-rate' id='review-rate"+review_list[i]['id']+"' data-rate="+review_list[i]['rate']+" data-id="+review_list[i]['id']+"></div><p class='review-name'>"+review_list[i]["user"]["name"]+"</p><pre>"+review_list[i]['review']+"</pre><p class='review-created'>"+created_t+"</p></li>").appendTo("#review-list");
